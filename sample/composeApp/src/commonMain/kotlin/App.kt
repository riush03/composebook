package ke.dennotech.composebook
...
import ke.dennotech.composebook.model.controls.BooleanControl.Companion.rememberBooleanControl
import ke.dennotech.composebook.model.controls.ColorControl.Companion.rememberColorControl
import ke.dennotech.composebook.model.controls.StringControl.Companion.rememberStringControl
import ke.dennotech.composebook.model.composebook
import ke.dennotech.composebook.ui.Composebook

@Composable
fun App(decorators: List<Decorator> = emptyList(), extension: Composebook.() -> Unit = {}) {
    MaterialTheme {
        Composebook(storyBook.apply {
            decorators
            extension()
        })
...
private val storyBook = composebook {
    group("Button") {
        story("Playground") {
